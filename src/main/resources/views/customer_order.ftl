...
<div id="p" class="easyui-panel" title="客户信息" style="width: 700px;height: 200px;padding: 10px;">
    <table cellspacing="8px">
        <tr>
            ...
            <td>法人</td>
            <td>
                <input type="text" readonly="readonly" value="${(customer.fr)!}"/>
            </td>
        </tr>
        <tr>
            <td>客户地址</td>
            <td>
                <input type="text" readonly="readonly" value="${(customer.address)!}"/>
            </td><td></td>
            <td>客户电话</td>
            <td>
                <input type="text" readonly="readonly" value="${(customer.phone)!}"/>
            </td>
        </tr>
    </table>
</div>
<br/>
<table id="dg" title="客户订单展示" class="easyui-datagrid" fitColumns="true" pagination="true"
       rownumbers="true" url="${ctx}/order/list?cid=${customer.id}" toolbar="#br" style="width: 750px;height: auto;"
       singleSelect="true">
    <thead>
    <tr>
        <th>
...
<div id="tb">
    订单编号:<input type="text" id="s_orderNo" size="20"
                onkeydown="if (event.keyCode==13) serachOrders()"/>
...
<div id="dlg" class="easyui-dialog" style="width:600px;height:400px"
    ...
    <table id="dg02" title="商品列表" class="easyui-datagrid"
           ...
           url="${ctx}/order_details/list" toolbar="#tb02" style="width:auto;height: auto;" >
        <thead>
        <tr>
            <th field="cb" checkbox="true" align="center"></th>
            <th field="id" width="50" align="center">编号</th>
