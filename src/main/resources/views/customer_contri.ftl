...
<div id="tb">
    ...
    <div>
        客户名称：
        <input type="text" id="s_cusName" size="20" onkeydown="if(event.keyCode==13) searchByParams()"/>
        金额区间：
        <select id="s_type" class="easyui-combobox" name="s_type" style="width:200px;" panelHeight="auto" editable="false">
        ...
        订单时间：
        <input type="text" class="easyui-datebox" id="s_time"  editable="false"/>
